...
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.7\textheight,keepaspectratio]{Aprox_195°.png}
...
\begin{itemize}
    ...
    \item Base de dados de direção e velocidade de corrente medida por ACDP (\emph{Acoustic Doppler Current Profile}).
\end{itemize}
...
\begin{itemize}
    ...
    \item O vetor representativo é \SI{0,165}{m/s} azimute $\SI{195}{\degree}$
\end{itemize}
...
\begin{columns}[T]
    \begin{column}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth,height=0.72\textheight,keepaspectratio]{batimetria_Atafona.png}
