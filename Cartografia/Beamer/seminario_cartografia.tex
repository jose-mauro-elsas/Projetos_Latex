...
% =========================================================
\begin{frame}{Soluções Propostas}
\begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
        \centering
...
\begin{columns}[T]
    \begin{column}{0.48\textwidth}
        ...
        \vspace{0.2cm}
        \footnotesize Fonte: Autor ou referência da imagem.
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
        \begin{itemize}
            ...
            \item Esse comportamento é consistente com estudos recentes sobre a dinâmica costeira em Atafona \cite{machado2024_dinamica_linha_costa_paraiba_sul}.
...
\begin{columns}[T]
    \begin{column}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{batimetria_Atafona._II.png}
    ...
    \begin{column}{0.48\textwidth}
        \begin{itemize}
            ...
            \item a constução de um quebra-mar com Core-loc\texttrademark pode fazer parte da mitigação do problema.
        \end{itemize}
    \end{column}
\end{columns}
\end{frame}
