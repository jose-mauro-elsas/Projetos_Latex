...
O trabalho vai analisar as consequências do descomissionamento de plataformas e sistemas de produção de oleo e gás no Brasil.

considerando
\begin{itemize}
      \item o aspecto técnico: (o que deve ser feito para executar o descomissionamento com o núnimo de acidentes e menor impacto ambiental).
      \item o aspecto oceanográfico: (dadas as condições de ventos, ondas, correntezas e salinidade como evitar impactos ambientais relevantes na área de onde saem os equipamentos, inclusive devolvento as àreas a sua condição original) e;
      \item como evitar que a parte feita em terra seja feita com mitigação de riscos de acidentes e o menor impacto ambiental.
